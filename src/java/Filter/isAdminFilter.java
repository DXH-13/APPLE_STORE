...
//        String url = req.getServletPath();
        ...
        if (ses.getAttribute("account") == null) {
            ...
            Accounts a = (Accounts) ses.getAttribute("account");
            if (a.getIsAdmin() == 1) {
                req.getRequestDispatcher("ManageControl").forward(request, response);
            } else {
                req.getRequestDispatcher("BlockControl").forward(request, response);
            }
        }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("isAdminFilter(");
