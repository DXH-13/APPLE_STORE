    ...
    <body>
        ...
        <jsp:include page="Navbar.jsp"></jsp:include>
            ...
            <div class="header-product">
                <h1>Buy ${listO.p.productName}</h1>
            <p>From $${listO.price} or $29.12/mo.per month for 24 months*</p>
        </div>
        <form name="f" action="" method="post">
            <div class="container-product">
                <div class="product-detail">
                    <div class="product-image">
                        <img src="${listO.photo1}" alt="">
                    </div>
                    <div class="product-content">
                        <h2 class="product-name">${listO.p.productName}</h2>
                        <div class="product-price">$${listO.price}</div>
                        <div class="product-description">${listO.p.description}</div>
